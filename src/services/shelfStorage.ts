...
const INITIAL_POLLS: PredictionPoll[] = [
  {
    ...
    options: [
      { id: 'opt-1', text: 'Yes, surpassing Mugen Train easily', votes: 890 },
      { id: 'opt-2', text: 'Top 3, but Mugen Train stays #1', votes: 410 },
      { id: 'opt-3', text: 'No, domestic Japan only records', votes: 120 },
    ],
  },
  {
    id: 'poll-2',
    ...
    options: [
      { id: 'opt-2a', text: 'Yuta Okkotsu in Sendai Colony', votes: 460 },
      { id: 'opt-2b', text: 'Kinji Hakari vs. Kashimo', votes: 380 },
      { id: 'opt-2c', text: 'Megumi Fushiguro vs. Reggie Star', votes: 140 },
    ],
  },
  {
    id: 'poll-3',
    ...
    options: [
      { id: 'opt-3a', text: 'MAPPA cinema-grade bomb action choreography', votes: 410 },
      { id: 'opt-3b', text: 'Denji & Reze dynamic & romantic tension', votes: 240 },
      { id: 'opt-3c', text: 'Original cinematic soundtrack by Kensuke Ushio', votes: 80 },
    ],
  },
];
